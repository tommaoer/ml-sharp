...
from . import finetune, finetune_ddp, predict, predict_finetune, render, render_invisible_mask
...
main_cli.add_command(predict_finetune.predict_finetune_cli, "predict-finetune")
